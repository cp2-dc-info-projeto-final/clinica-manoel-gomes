    ...
    <div id="cad_cliente" class="block">
        <div class="container">
          ...
          <div class="registration-form">
            <form action="cod_senha.php" method="POST">
                <div class="form-icon">
                    <span><i class="icon far fa-id-card"></i></span>
                </div>   
                <h5 class="text-uppercase">Digite o código de verificação:</h5>
                <?php
                ...
                ?>
                <?php
                    if(isset($_SESSION['erro_cod'])){
                      echo $_SESSION['erro_cod'];
                      unset($_SESSION['erro_cod']);
                  }
                ?>
                <br>
                <div class="form-group">
                    <input type="text" required="required" class="form-control item" id="cod_senha" name="cod_senha" maxlength="6" placeholder="000000">
                    <script type="text/javascript">$("#cod_senha").mask("000000");</script>
                </div>
                <div class="form-group">
